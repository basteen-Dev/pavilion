...
export async function createQuotation(data) {
    try {
        ...
        for (const item of items) {
            await query(
                `INSERT INTO quotation_items (quotation_id, product_id, product_name, quantity, unit_price, total_price, line_total, variant_info, mrp, discount)
